	...
	<div id="main">
		<header>
				...
				<span id="spanNav"> <h1> DIT Libary </h1> </span>
                  ...
                  <li><a href="user.php">Home</a></li></ul>
				</nav>	
		</header>
	</div>

	<div id="content">	
	<form method="post" action="delete.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin w3-display-middle" style="width:50%">
<h2 class="w3-center">Account Deletion</h2>
 <h3> Please enter your name and password to delete</h3>
